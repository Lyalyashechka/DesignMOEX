...
## 7. Список серверов.
* NGINX   
Количество RPS nginx на 36 ядерном процессоре для запрососов 1кб - 1 309 358 [источник](https://www.nginx.com/blog/testing-the-performance-of-nginx-and-nginx-plus-web-servers/), для задач биржи хватит 1 такого сервера. 
* trade_api  
