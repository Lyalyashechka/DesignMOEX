...
### 1.1 Тема.
   ...
   |---|
   |1. Авторизация|
   |2. Получение актуальных котировок по парам|
   |3. Получение информации о стакане|
   |4. Осуществление сделки на рынке| 
   |5. Получение истории торгов по паре|  
...
\\   Ежедневное количество пользователей биржи 2 785 000, предположим что каждый из них хотя бы раз в среднем сделает запрос на получение 30 своих последних ордеров.  
 ...
 500 000 / 17 / 60 * 2 = 980 (17 - количество рабочих часов биржи в сутки)
   ...
   Также предположим что в среднем пользователь тратит 1 минуту пребывания в приложении на просмотр истории торгов по какой-либо паре. 
   |Тип действия | Количество в день| 
   |-------------|------------------|
   |Авторизация  |                  |
   |Оформление сделки| 1.22| 
   |Отслеживание ситуации в стакане|240|  
